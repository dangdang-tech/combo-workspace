...
There are 77 features in the catalog. 22 of them have a switch you can
reach; the other 55 are decided before you get there.
...
| `sharing.sessionEntries` | Invite-based entries allocating a private conversation per account on the owner machine. | server | `sharing.session`, `sharing.contentKeys` |
