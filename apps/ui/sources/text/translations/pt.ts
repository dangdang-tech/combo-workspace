...
export const pt: TranslationStructure = {
    ...
    sharedEntry: {
        ...
        guidePrepareTitle: "Compartilhe uma conversa existente ou comece aqui",
        guideSteps: "1 Escolha uma conversa → 2 Peça ao Codex para publicar um link → 3 Seu convidado continua na web",
        guidePrepareBody: "Se você já tem uma conversa no Codex, peça ao Codex para publicar a conversa que escolher; não é preciso recriá-la na web. Você também pode iniciar uma nova conversa abaixo e, quando estiver pronta, escolher “Compartilhar conversa”.",
        inviteSteps: "1 Entrar · 2 Preparar sua cópia · 3 Conversar",
        inviteStepSignIn: "Etapa 1: entre com o Google",
        inviteStepPrepare: "Etapa 2: prepare sua própria conversa",
        inviteStepOpen: "Etapa 3: abra sua conversa",
        prepareCopy: "Preparar minha conversa",
        inviteHostOffline: "O host está offline. Peça à pessoa que enviou o convite para iniciá-lo e tente novamente.",
        inviteSnapshotUnavailable: "Não é possível copiar o contexto salvo. Peça à pessoa que enviou o convite para criar e enviar um novo convite.",
        linkGoogle: "Vincular Google a esta conta",
        restoreKeys: "Recuperar as chaves da conta",
        inviteHostOfflineWaiting: "Aguardando o host ficar online para preparar sua cópia. Você pode atualizar o status mais tarde.",
        generateStep: "2 Crie um link de compartilhamento",
        contextDetail: "Seu convidado recebe uma conversa independente com o contexto salvo no momento do compartilhamento. Sua conversa não muda; os arquivos do projeto continuam compartilhados.",
        sendLinkDetail: "Copie o link e envie ao convidado. Ele entrará com o Google, preparará sua cópia e continuará conversando.",
        copiedDetail: "Link copiado. Envie ao convidado. Ele aparecerá na lista de membros depois de aceitar o convite.",
        linkUnavailable: "Esta página não salva links. Gere um novo para copiar novamente; o anterior expirará e os membros atuais manterão o acesso.",
        manageInvitations: "Gerenciar convites",
        hideManagement: "Ocultar gerenciamento de convites",
        copyFailed: "Não foi possível copiar o link. Tente novamente.",
        title: "Partilhar conversa",
        description: "Cada utilizador Google convidado recebe o contexto guardado ao criar o convite e continua na sua própria conversa. Os ficheiros do projeto são partilhados e o anfitrião paga a utilização do modelo.",
        ...
        rotateDetail: "O link anterior não aceitará novos convidados. Os membros atuais manterão o acesso.",
        canUse: "Pode usar",
        disabled: "Sem acesso",
        ...
        contextSnapshotRequired: "Este convite não tem contexto guardado. Pede ao anfitrião para criar uma nova captura para partilha.",
        contextSnapshotTooLarge: "A conversa é demasiado longa para copiar. Partilha uma conversa mais curta.",
        contextSnapshotUnavailable: "Não é possível copiar este contexto. Partilha uma conversa normal sem histórico ramificado.",
        createFresh: "Compartilhar a conversa atual",
        createFreshDetail: "Salve a conversa atual em um novo convite. Os membros atuais mantêm suas próprias conversas.",
        previousInvitations: "Outros convites",
        snapshotMissing: "Este convite antigo não tem contexto de conversa guardado.",
    },
    settingsKeyboard: {
  ...
  settingsFeatures: {
    ...
    voiceSubtitle: "Ativar recursos de voz",
      ...
      expChannelBridgesSubtitle: "Conecte Telegram e outros canais de chat a sessões do COMBO (experimental)",
    ...
    expSessionsFoldersSubtitle: "Organize sessões COMBO da barra lateral em pastas de workspace",
    ...
    groupInactiveSessionsByProjectSubtitle:
      ...
      environmentBadgeSubtitle:
        "Mostrar um pequeno badge ao lado do título COMBO indicando o ambiente atual do app",
...
settingsSession: {
      ...
      defaultPermissions: {
        ...
        applyPermissionChangesNextPromptSubtitle: "Aplicar somente na próxima mensagem.",
          ...
          defaultStorage: {
              ...
              footer: 'Escolha se novas sessões começam como sessões do COMBO ou sessões diretas apoiadas pelo provedor.',
              globalTitle: 'Padrão global',
              persistedSubtitle: 'Armazene novas sessões no COMBO e sincronize-as entre dispositivos por padrão.',
  ...
  welcome: {
    ...
    brandSubTagline: "Partilha uma conversa com o seu contexto. Continua de forma independente com o Codex; os ficheiros do projeto são partilhados.",
  ...
  profiles: {
    ...
    defaultStorage: {
      title: 'Tipo de sessão padrão',
      footer: 'Substitui o tipo de sessão padrão COMBO/direto no nível da conta para novas sessões quando este perfil estiver selecionado.',
