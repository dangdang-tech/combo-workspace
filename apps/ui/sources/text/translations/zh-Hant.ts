...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
    sourceSetup: {
        title: "從原始碼連接主機",
        body: "當當 Agent 尚未發布獨立安裝包。請使用本倉庫原始碼；上游安裝包不包含共享入口。",
        openGuide: "開啟原始碼連接指南",
        cloneTitle: "取得並建置本倉庫",
        cloneBody: "在主機上準備 Node.js 22、Yarn Classic 1.22 和 Codex。",
        connectTitle: "連接目前服務",
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "第 3 步：開啟對話並繼續",
        prepareCopy: "準備我的對話副本",
        inviteHostOffline: "分享者的主機離線。請聯絡分享者啟動主機，再重試準備副本。",
        inviteSnapshotUnavailable: "此邀請的聊天內容無法複製。請聯絡分享者建立並傳送新的邀請。",
        linkGoogle: "將 Google 身分連結至目前帳號",
        restoreKeys: "復原帳號金鑰",
        inviteHostOfflineWaiting: "等待分享者的主機上線，隨後會繼續準備副本。你可以稍後重新整理狀態。",
        generateStep: "2 產生分享連結",
        contextDetail: "對方會從分享時的內容開始獨立對話。你的原對話不變，專案檔案仍然共用。",
        sendLinkDetail: "複製後，將連結傳給對方。對方用 Google 登入、準備好副本後，就能接著聊。",
        copiedDetail: "連結已複製，傳給對方即可。對方接受邀請後，會出現在下方成員清單。",
        linkUnavailable: "此頁面不儲存分享連結。需要再次複製時，請產生新連結；舊連結將失效，現有成員不受影響。",
        manageInvitations: "管理邀請",
        hideManagement: "收起邀請管理",
        copyFailed: "無法複製連結，請重試。",
        title: "分享會話",
        description: "每位受邀 Google 使用者取得建立邀請時的聊天上下文，再於自己的會話中繼續聊。專案檔案共用，模型費用由主機方承擔。",
        create: "產生分享連結",
        name: "分享名稱",
        members: "成員",
        noMembers: "暫時還沒有人接受邀請",
        copy: "複製邀請連結",
        copied: "邀請連結已複製",
        rotate: "重新產生連結",
        rotateDetail: "舊連結將無法再邀請新成員，已加入的成員不受影響。",
        canUse: "可使用",
        disabled: "無權存取",
        enable: "允許存取",
        disable: "停用存取",
        preparing: "正在準備你的專屬對話",
        preparingDetail: "主機正在建立你的專屬對話並準備加密存取。",
        preparationFailed: "專屬對話準備失敗。主機可用後請重試。",
        hostOffline: "主機離線，暫不可執行。草稿會保留，主機上線後請手動傳送。",
        accessDisabled: "存取已停用，請聯絡主機方。",
        googleRequired: "請使用已連結 Google 的帳號接受邀請。",
        keysRequired: "加密存取尚未準備好。請復原或連結帳號金鑰後重試。",
        inviteInvalid: "邀請無效或已不可用。",
        accept: "接受邀請",
        signIn: "使用 Google 登入並繼續",
        connectServer: "連接邀請指定的伺服器",
        checking: "正在檢查主機狀態",
        refresh: "重新整理狀態",
        ...
        createFresh: "分享最新的對話",
        createFreshDetail: "將目前聊天內容放入新邀請。已加入的成員保留原來的對話。",
  ...
  settings: {
        ...
        aboutFooter: "當當 Agent 是基於 Happier 的共享程式開發工作台。專案檔案共享，每位成員的對話獨立儲存。",
        whatsNew: '更新日誌',
...
settingsSession: {
    ...
    welcome: {
        ...
        frontDoorOtherConversation: "協作者的對話",
        frontDoorYourConversation: "你的對話",
        frontDoorProject: "同一個專案目錄",
        frontDoorEyebrow: "共享 Codex 工作區",
        providerMarkRowAccessibilityLabel: '支援的 AI 編碼代理',

        // Unified onboarding redesign — welcome decision (right pane)
        welcomeQuestionTitle: "進入你的工作區。",
        welcomeQuestionSubtitle: "從你的帳號開始。",
        welcomeQuestionBody: "建立新帳號，或還原既有帳號。透過邀請加入專案時，登入後會返回邀請頁面。",

        welcomePrimaryButton: "建立帳號",
        welcomePrimarySubtitle: "從目前裝置開始。",

        welcomeSecondaryButton: "登入既有帳號",
        welcomeSecondarySubtitle: "掃描 QR 碼，或輸入復原金鑰。",
