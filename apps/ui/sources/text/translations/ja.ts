...
export const ja: TranslationStructure = {
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "ステップ3：会話を開いて続ける",
        prepareCopy: "自分の会話を準備",
        inviteHostOffline: "ホストがオフラインです。共有者に起動を依頼し、もう一度お試しください。",
        inviteSnapshotUnavailable: "この招待の会話内容をコピーできません。共有者に新しい招待の作成と送信を依頼してください。",
        linkGoogle: "このアカウントに Google を連携",
        restoreKeys: "アカウントの鍵を復元",
        inviteHostOfflineWaiting: "ホストがオンラインになるとコピーの準備が進みます。後で状態を更新できます。",
        generateStep: "2 共有リンクを作成",
        contextDetail: "相手は共有時の内容を引き継いだ独立した会話を利用できます。元の会話は変わりません。プロジェクトのファイルは共有されます。",
        sendLinkDetail: "リンクをコピーして相手に送信します。相手は Google でログインし、コピーを準備して会話を続けられます。",
        copiedDetail: "リンクをコピーしました。相手に送信してください。招待を受け入れると、下のメンバー一覧に表示されます。",
        linkUnavailable: "このページにはリンクを保存しません。再度コピーするには新しいリンクを作成してください。古いリンクは無効になりますが、既存メンバーのアクセスは維持されます。",
        manageInvitations: "招待を管理",
        hideManagement: "招待管理を閉じる",
        ...
        rotate: "新しいリンクを作成",
        rotateDetail: "古いリンクでは新しいメンバーを招待できなくなります。既存メンバーのアクセスは維持されます。",
        canUse: "利用可能",
        disabled: "アクセス不可",
        enable: "アクセスを許可",
        disable: "アクセスを停止",
        ...
        createFresh: "最新の会話を共有",
        createFreshDetail: "現在の会話を新しい招待に保存します。既存メンバーの会話はそのままです。",
