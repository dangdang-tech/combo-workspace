...
export const zhHans: TranslationStructure = {
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "第 3 步：打开会话并继续",
        prepareCopy: "准备我的会话副本",
        inviteHostOffline: "分享者的主机离线。请联系分享者启动主机，再重试准备副本。",
        inviteSnapshotUnavailable: "此邀请的聊天上下文无法复制。请联系分享者创建并发送新的邀请。",
        linkGoogle: "关联当前账号的 Google 身份",
        restoreKeys: "恢复账号密钥",
        inviteHostOfflineWaiting: "等待分享者的主机上线，随后会继续准备副本。你可以稍后刷新状态。",
        generateStep: "2 生成分享链接",
        contextDetail: "对方会从分享时的上下文开始独立对话。你的原对话不变，项目文件仍然共用。",
        sendLinkDetail: "复制后，将链接发给对方。对方用 Google 登录、准备好副本后，就能接着聊。",
        copiedDetail: "链接已复制，发给对方即可。对方接受邀请后，会出现在下方成员列表。",
        linkUnavailable: "此页面不保存分享链接。需要再次复制时，请生成新链接；旧链接将失效，现有成员不受影响。",
        manageInvitations: "管理邀请",
        hideManagement: "收起邀请管理",
        copyFailed: "未能复制链接，请重试。",
        title: "分享会话",
        ...
        copied: "邀请链接已复制",
        rotate: "重新生成链接",
        rotateDetail: "旧链接将不能再邀请新成员，已加入的成员不受影响。",
        canUse: "可使用",
        disabled: "无权访问",
        enable: "允许访问",
        disable: "停用访问",
        ...
        createFresh: "分享最新的对话",
        createFreshDetail: "将当前聊天内容放入新邀请。已加入的成员保留原来的对话。",
