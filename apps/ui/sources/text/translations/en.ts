...
export const en = {
    sourceSetup: {
        ...
        connectTitle: "Connect to the selected server",
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "Step 3: Open your conversation",
        prepareCopy: "Prepare my conversation",
        inviteHostOffline: "The host is offline. Ask the person who shared this invite to start it, then try again.",
        inviteSnapshotUnavailable: "This invite’s saved context cannot be copied. Ask the person who shared it to create and send a new invite.",
        linkGoogle: "Link Google to this account",
        restoreKeys: "Recover account keys",
        inviteHostOfflineWaiting: "Waiting for the host to come online before preparing your copy. You can refresh the status later.",
        generateStep: "2 Generate a sharing link",
        contextDetail: "Your guest gets an independent conversation with the context saved when you share. Your original conversation stays unchanged; project files remain shared.",
        sendLinkDetail: "Copy the link and send it to your guest. They sign in with Google, prepare their copy, and continue chatting.",
        copiedDetail: "Link copied. Send it to your guest. They will appear in the member list after accepting the invite.",
        linkUnavailable: "This page does not save sharing links. Generate a new link to copy it again; the old link will expire and existing members keep access.",
        manageInvitations: "Manage invitations",
        hideManagement: "Hide invitation management",
        ...
        name: "Sharing name",
        members: "Members",
        noMembers: "No one has accepted yet",
        copy: "Copy invitation link",
        copied: "Invitation link copied",
        rotate: "Generate a new link",
        rotateDetail: "The old link will stop accepting new guests. Existing members keep access.",
        canUse: "Can use",
        disabled: "No access",
        enable: "Allow access",
        disable: "Disable access",
        preparing: "Preparing your conversation",
        preparingDetail: "The host is creating your own conversation and preparing encrypted access.",
        preparationFailed: "Conversation preparation failed. Retry when the host is available.",
        hostOffline: "Host offline. Your draft is kept; send it manually when the host is online.",
        accessDisabled: "Access has been disabled. Contact the host.",
        googleRequired: "Use a Google-linked account to accept this invitation.",
        keysRequired: "Encrypted access is not ready. Restore or connect your account keys, then retry.",
        inviteInvalid: "This invitation is invalid or no longer available.",
        accept: "Accept invitation",
        signIn: "Sign in with Google to continue",
        connectServer: "Continue on the invitation server",
        checking: "Checking host availability",
        ...
        createFresh: "Share the latest conversation",
        createFreshDetail: "Save the current conversation in a new invitation. Existing members keep their own conversations.",
...
settingsSession: {
    ...
    welcome: {
        ...
        frontDoorOtherConversation: "A collaborator’s conversation",
        frontDoorYourConversation: "Your conversation",
        frontDoorProject: "One project directory",
        frontDoorEyebrow: "Shared Codex workspace",
        providerMarkRowAccessibilityLabel: 'Supported AI coding agents',

        // Unified onboarding redesign — welcome decision (right pane)
        welcomeQuestionTitle: "Enter your workspace.",
        welcomeQuestionSubtitle: "Start with your account.",
        welcomeQuestionBody: "Create a new account, or restore the account you already use. Invitations continue after sign-in.",

        welcomePrimaryButton: "Create an account",
        welcomePrimarySubtitle: "Start on this device.",

        welcomeSecondaryButton: "Sign in to an existing account",
        welcomeSecondarySubtitle: "Use a QR code or your recovery key.",
