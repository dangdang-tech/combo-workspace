...
export const es: TranslationStructure = {
    sourceSetup: {
        ...
        connectTitle: "Conectar al servidor seleccionado",
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "Paso 3: Abre tu conversación",
        prepareCopy: "Preparar mi conversación",
        inviteHostOffline: "El anfitrión está desconectado. Pide a quien te invitó que lo inicie y vuelve a intentarlo.",
        inviteSnapshotUnavailable: "No se puede copiar el contexto guardado. Pide a quien te invitó que cree y envíe una nueva invitación.",
        linkGoogle: "Vincular Google a esta cuenta",
        restoreKeys: "Recuperar las claves de la cuenta",
        inviteHostOfflineWaiting: "Esperando a que el anfitrión se conecte para preparar tu copia. Puedes actualizar el estado más tarde.",
        generateStep: "2 Crea un enlace para compartir",
        contextDetail: "Tu invitado recibe una conversación independiente con el contexto guardado al compartir. Tu conversación no cambia; los archivos del proyecto siguen compartidos.",
        sendLinkDetail: "Copia el enlace y envíaselo a tu invitado. Iniciará sesión con Google, preparará su copia y continuará conversando.",
        copiedDetail: "Enlace copiado. Envíalo a tu invitado. Aparecerá en la lista de miembros cuando acepte la invitación.",
        linkUnavailable: "Esta página no guarda enlaces. Genera uno nuevo para volver a copiarlo; el anterior caducará y los miembros actuales conservarán el acceso.",
        manageInvitations: "Gestionar invitaciones",
        hideManagement: "Ocultar gestión de invitaciones",
        copyFailed: "No se pudo copiar el enlace. Inténtalo de nuevo.",
        ...
        create: "Generar enlace para compartir",
        name: "Nombre del enlace",
        members: "Miembros",
        noMembers: "Nadie ha aceptado todavía",
        copy: "Copiar enlace de invitación",
        copied: "Enlace de invitación copiado",
        rotate: "Generar un nuevo enlace",
        rotateDetail: "El enlace anterior no admitirá nuevos invitados. Los miembros actuales conservarán el acceso.",
        canUse: "Puede usar",
        disabled: "Sin acceso",
        enable: "Permitir acceso",
        disable: "Desactivar acceso",
        preparing: "Preparando tu conversación",
        preparingDetail: "El anfitrión está creando tu conversación y preparando el acceso cifrado.",
        preparationFailed: "La preparación falló. Reinténtalo cuando el anfitrión esté disponible.",
        hostOffline: "Anfitrión sin conexión. Tu borrador se conserva; envíalo manualmente cuando vuelva a estar conectado.",
        accessDisabled: "Se ha desactivado el acceso. Contacta con el anfitrión.",
        googleRequired: "Usa una cuenta vinculada a Google para aceptar esta invitación.",
        keysRequired: "El acceso cifrado no está listo. Restaura o conecta las claves de tu cuenta y reinténtalo.",
        inviteInvalid: "Esta invitación no es válida o ya no está disponible.",
        accept: "Aceptar invitación",
        signIn: "Inicia sesión con Google para continuar",
        connectServer: "Continuar en el servidor de la invitación",
        checking: "Comprobando el anfitrión",
        ...
        createFresh: "Compartir la conversación actual",
        createFreshDetail: "Guarda la conversación actual en una nueva invitación. Los miembros actuales conservan sus propias conversaciones.",
...
settingsSession: {
  ...
  welcome: {
    ...
    frontDoorOtherConversation: "Conversación de un colaborador",
    frontDoorYourConversation: "Tu conversación",
    frontDoorProject: "Un directorio de proyecto",
    frontDoorEyebrow: "Espacio compartido de Codex",
    ...
    welcomeQuestionTitle: "Entra en tu espacio.",
    welcomeQuestionSubtitle: "Empieza con tu cuenta.",
    welcomeQuestionBody: "Crea una cuenta o restaura la que ya usas. Las invitaciones continúan después de iniciar sesión.",

    welcomePrimaryButton: "Crear una cuenta",
    welcomePrimarySubtitle: "Empezar en este dispositivo.",

    welcomeSecondaryButton: "Iniciar sesión con una cuenta existente",
    welcomeSecondarySubtitle: "Usa un código QR o tu clave de recuperación.",
