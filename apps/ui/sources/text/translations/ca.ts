...
export const ca: TranslationStructure = {
    sourceSetup: {
        ...
        connectTitle: "Connectar el servidor seleccionat",
    ...
    sharedEntry: {
        ...
        guidePrepareTitle: "Comparteix una conversa existent o comença aquí",
        guideSteps: "1 Tria una conversa → 2 Demana a Codex que publiqui l’enllaç → 3 El convidat continua al web",
        guidePrepareBody: "Si ja tens una conversa a Codex, demana-li que publiqui la conversa que triïs; no cal tornar-la a crear al web. També pots iniciar-ne una de nova aquí sota i, quan estigui preparada, triar «Comparteix la conversa».",
        inviteSteps: "1 Inicia sessió · 2 Prepara la còpia · 3 Conversa",
        inviteStepSignIn: "Pas 1: inicia sessió amb Google",
        inviteStepPrepare: "Pas 2: prepara la teva conversa",
        inviteStepOpen: "Pas 3: obre la conversa",
        prepareCopy: "Prepara la meva conversa",
        inviteHostOffline: "L’amfitrió està desconnectat. Demana a qui t’ha convidat que l’iniciï i torna-ho a provar.",
        inviteSnapshotUnavailable: "No es pot copiar el context desat. Demana a qui t’ha convidat que creï i enviï una invitació nova.",
        linkGoogle: "Vincula Google a aquest compte",
        restoreKeys: "Recupera les claus del compte",
        inviteHostOfflineWaiting: "S’espera que l’amfitrió es connecti per preparar la còpia. Pots actualitzar l’estat més tard.",
        generateStep: "2 Crea un enllaç per compartir",
        contextDetail: "El convidat rep una conversa independent amb el context desat en compartir-la. La teva conversa no canvia; els fitxers del projecte continuen compartits.",
        sendLinkDetail: "Copia l’enllaç i envia’l al convidat. Iniciarà sessió amb Google, prepararà la còpia i continuarà conversant.",
        copiedDetail: "Enllaç copiat. Envia’l al convidat. Apareixerà a la llista de membres després d’acceptar la invitació.",
        linkUnavailable: "Aquesta pàgina no desa enllaços. Genera’n un de nou per tornar-lo a copiar; l’anterior caducarà i els membres actuals conservaran l’accés.",
        manageInvitations: "Gestiona les invitacions",
        hideManagement: "Amaga la gestió d’invitacions",
        copyFailed: "No s’ha pogut copiar l’enllaç. Torna-ho a provar.",
        ...
        create: "Genera un enllaç per compartir",
        name: "Nom de la compartició",
        members: "Membres",
        noMembers: "Encara no ha acceptat ningú",
        copy: "Copia l’enllaç d’invitació",
        copied: "Enllaç d’invitació copiat",
        rotate: "Genera un enllaç nou",
        rotateDetail: "L’enllaç anterior no acceptarà nous convidats. Els membres actuals conservaran l’accés.",
        canUse: "Pot utilitzar",
        disabled: "Sense accés",
        enable: "Permet l’accés",
        disable: "Desactiva l’accés",
        preparing: "S’està preparant la teva conversa",
        preparingDetail: "L’amfitrió està creant la teva conversa i preparant l’accés xifrat.",
        preparationFailed: "La preparació ha fallat. Torna-ho a provar quan l’amfitrió estigui disponible.",
        hostOffline: "Amfitrió fora de línia. Es conserva l’esborrany; envia’l manualment quan torni a estar connectat.",
        accessDisabled: "S’ha desactivat l’accés. Contacta amb l’amfitrió.",
        googleRequired: "Utilitza un compte vinculat a Google per acceptar aquesta invitació.",
        keysRequired: "L’accés xifrat no està preparat. Restaura o connecta les claus del compte i torna-ho a provar.",
        inviteInvalid: "Aquesta invitació no és vàlida o ja no està disponible.",
        accept: "Accepta la invitació",
        signIn: "Inicia sessió amb Google per continuar",
        connectServer: "Continua al servidor de la invitació",
        checking: "S’està comprovant l’amfitrió",
        ...
        createFresh: "Comparteix la conversa actual",
        createFreshDetail: "Desa la conversa actual en una invitació nova. Els membres actuals conserven les seves converses.",
...
settingsSession: {
    ...
    welcome: {
        ...
        frontDoorOtherConversation: "Conversa d’un col·laborador",
        frontDoorYourConversation: "La teva conversa",
        frontDoorProject: "Un directori de projecte",
        frontDoorEyebrow: "Espai Codex compartit",
        ...
        welcomeQuestionTitle: "Entra al teu espai.",
        welcomeQuestionSubtitle: "Comença amb el teu compte.",
        welcomeQuestionBody: "Crea un compte o restaura el que ja utilitzes. Les invitacions continuen després d’iniciar la sessió.",

        welcomePrimaryButton: "Crear un compte",
        welcomePrimarySubtitle: "Començar en aquest dispositiu.",

        welcomeSecondaryButton: "Entrar en un compte existent",
        welcomeSecondarySubtitle: "Fes servir un codi QR o la clau de recuperació.",
