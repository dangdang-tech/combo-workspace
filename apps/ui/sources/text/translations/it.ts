...
export const it: TranslationStructure = {
    sourceSetup: {
        ...
        connectTitle: "Collega il server selezionato",
    ...
    sharedEntry: {
        ...
        inviteStepOpen: "Passaggio 3: apri la conversazione",
        prepareCopy: "Prepara la mia conversazione",
        inviteHostOffline: "L’host è offline. Chiedi alla persona che ti ha invitato di avviarlo, poi riprova.",
        inviteSnapshotUnavailable: "Impossibile copiare il contesto salvato. Chiedi alla persona che ti ha invitato di creare e inviare un nuovo invito.",
        linkGoogle: "Collega Google a questo account",
        restoreKeys: "Recupera le chiavi dell’account",
        inviteHostOfflineWaiting: "In attesa che l’host torni online per preparare la copia. Puoi aggiornare lo stato più tardi.",
        generateStep: "2 Crea un link di condivisione",
        contextDetail: "L’ospite riceve una conversazione indipendente con il contesto salvato al momento della condivisione. La tua conversazione resta invariata; i file del progetto restano condivisi.",
        sendLinkDetail: "Copia il link e invialo all’ospite. Potrà accedere con Google, preparare la propria copia e continuare a conversare.",
        copiedDetail: "Link copiato. Invialo all’ospite. Comparirà nell’elenco dei membri dopo aver accettato l’invito.",
        linkUnavailable: "Questa pagina non salva i link. Generane uno nuovo per copiarlo di nuovo; il precedente scadrà e i membri attuali manterranno l’accesso.",
        manageInvitations: "Gestisci inviti",
        hideManagement: "Nascondi gestione inviti",
        copyFailed: "Impossibile copiare il link. Riprova.",
        ...
        create: "Crea il link di condivisione",
        name: "Nome della condivisione",
        members: "Membri",
        noMembers: "Nessuno ha ancora accettato",
        copy: "Copia link di invito",
        copied: "Link di invito copiato",
        rotate: "Crea un nuovo link",
        rotateDetail: "Il vecchio link non accetterà nuovi ospiti. I membri attuali manterranno l’accesso.",
        canUse: "Può usare",
        disabled: "Nessun accesso",
        enable: "Consenti accesso",
        disable: "Disabilita accesso",
        preparing: "Preparazione della conversazione",
        preparingDetail: "L’host sta creando la tua conversazione e preparando l’accesso crittografato.",
        preparationFailed: "Preparazione non riuscita. Riprova quando l’host è disponibile.",
        hostOffline: "Host offline. La bozza viene conservata; inviala manualmente quando l’host torna online.",
        accessDisabled: "L’accesso è stato disabilitato. Contatta l’host.",
        googleRequired: "Usa un account collegato a Google per accettare questo invito.",
        keysRequired: "L’accesso crittografato non è pronto. Ripristina o collega le chiavi dell’account e riprova.",
        inviteInvalid: "Questo invito non è valido o non è più disponibile.",
        accept: "Accetta invito",
        signIn: "Accedi con Google per continuare",
        connectServer: "Continua sul server dell’invito",
        checking: "Verifica della disponibilità dell’host",
        ...
        createFresh: "Condividi la conversazione attuale",
        createFreshDetail: "Salva la conversazione attuale in un nuovo invito. I membri attuali mantengono le proprie conversazioni.",
...
settingsSession: {
  ...
  welcome: {
    ...
    frontDoorOtherConversation: "Conversazione di un collaboratore",
    frontDoorYourConversation: "La tua conversazione",
    frontDoorProject: "Una cartella di progetto",
    frontDoorEyebrow: "Spazio Codex condiviso",
    ...
    welcomeQuestionTitle: "Entra nel tuo spazio.",
    welcomeQuestionSubtitle: "Inizia dal tuo account.",
    welcomeQuestionBody: "Crea un account o ripristina quello che usi già. Gli inviti continuano dopo l’accesso.",

    welcomePrimaryButton: "Crea un account",
    welcomePrimarySubtitle: "Inizia su questo dispositivo.",

    welcomeSecondaryButton: "Accedi a un account esistente",
    welcomeSecondarySubtitle: "Usa un codice QR o la chiave di recupero.",
