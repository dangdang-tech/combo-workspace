...
export const ru: TranslationStructure = {
    ...
    sharedEntry: {
        ...
        createFresh: "Создать новый снимок для доступа",
        createFreshDetail: "Сохранить текущий контекст в новом приглашении. Участники сохранят свои существующие беседы.",
