...
export const ru: TranslationStructure = {
    sourceSetup: {
        ...
        body: "У COMBO пока нет отдельного установщика. Используйте этот репозиторий: установщики исходного проекта не содержат общих рабочих пространств.",
    ...
    sharedEntry: {
        ...
        guidePrepareTitle: "Поделитесь существующей беседой или начните здесь",
        guideSteps: "1 Выберите беседу → 2 Попросите Codex опубликовать ссылку → 3 Гость продолжит в браузере",
        guidePrepareBody: "Если у вас уже есть беседа в Codex, попросите его опубликовать выбранную беседу; создавать её заново в браузере не нужно. Можно также начать новую беседу ниже, а когда она будет готова, выбрать «Поделиться беседой».",
        inviteSteps: "1 Войти · 2 Подготовить копию · 3 Начать беседу",
        inviteStepSignIn: "Шаг 1: войдите через Google",
        inviteStepPrepare: "Шаг 2: подготовьте свою беседу",
        inviteStepOpen: "Шаг 3: откройте беседу",
        prepareCopy: "Подготовить мою беседу",
        inviteHostOffline: "Хост не в сети. Попросите отправителя приглашения запустить его и повторите попытку.",
        inviteSnapshotUnavailable: "Не удалось скопировать сохранённый контекст. Попросите отправителя создать и прислать новое приглашение.",
        linkGoogle: "Привязать Google к этому аккаунту",
        restoreKeys: "Восстановить ключи аккаунта",
        inviteHostOfflineWaiting: "Ожидание подключения хоста для подготовки копии. Вы можете обновить статус позже.",
        generateStep: "2 Создайте ссылку для отправки",
        contextDetail: "Гость получит независимую беседу с контекстом на момент отправки. Ваша беседа не изменится; файлы проекта останутся общими.",
        sendLinkDetail: "Скопируйте ссылку и отправьте гостю. Он войдёт через Google, подготовит копию и продолжит беседу.",
        copiedDetail: "Ссылка скопирована. Отправьте её гостю. После принятия приглашения он появится в списке участников.",
        linkUnavailable: "Эта страница не сохраняет ссылки. Создайте новую, чтобы скопировать её ещё раз. Старая перестанет действовать, а текущие участники сохранят доступ.",
        manageInvitations: "Управление приглашениями",
        hideManagement: "Скрыть управление приглашениями",
        copyFailed: "Не удалось скопировать ссылку. Повторите попытку.",
        title: "Поделиться беседой",
        description: "Каждый приглашённый пользователь Google получает контекст на момент создания приглашения и продолжает в собственной беседе. Файлы проекта общие, использование модели оплачивает владелец хоста.",
        create: "Создать ссылку",
        name: "Название приглашения",
        members: "Участники",
        ...
        rotateDetail: "Старая ссылка больше не принимает новых гостей. Текущие участники сохранят доступ.",
        ...
        contextSnapshotRequired: "В этом приглашении нет сохранённого контекста. Попросите владельца хоста создать новый снимок для совместного доступа.",
        contextSnapshotTooLarge: "Беседа слишком длинная для копирования. Поделитесь более короткой беседой.",
        contextSnapshotUnavailable: "Не удалось скопировать этот контекст. Поделитесь обычной беседой без разветвлённой истории.",
        createFresh: "Поделиться текущей беседой",
        createFreshDetail: "Сохраните текущую беседу в новом приглашении. Текущие участники сохранят свои беседы.",
        previousInvitations: "Другие приглашения",
        snapshotMissing: "В этом старом приглашении нет сохранённого контекста беседы.",
    },
    settingsKeyboard: {
  ...
  settings: {
    ...
    aboutFooter:
      "COMBO — совместная среда разработки на основе Happier. Файлы проекта общие, а разговоры сохраняются отдельно.",
    whatsNew: "Что нового",
...
settingsSession: {
  ...
  welcome: {
    ...
    brandSubTagline: "Поделитесь беседой вместе с контекстом. Продолжайте независимо с Codex; файлы проекта остаются общими.",
