...
This checkout is **COMBO**, maintained at `dangdang-tech/combo-workspace`. The sections below retain Happier's engineering conventions and upstream terminology.
...
- The current product surface is the web workspace and host connector. Do not describe upstream installation packages or mobile/desktop store listings as releases of COMBO.
